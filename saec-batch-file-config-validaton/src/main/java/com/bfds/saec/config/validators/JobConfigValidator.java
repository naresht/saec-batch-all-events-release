...
public class JobConfigValidator implements Validator {
    ...
    private void verifyExpectedjobConfigList(List<JobConfig> jobConfigList, ValidationMessageContext messageContext) {
        Set<String> expectedMailingLists = Sets.newHashSet("DbIssueVoidRecJob", "DbStopPaymentRecJob", "OutboundCorporateAddressResearchJob",
                "OutboundIndividualAddressResearchJob", "DstoRecJob", "DstoRecJob", "IfdsCheckStatusRecJob", "IfdsIssueVoidRecJob", "SsIssueVoidRecJob",
                "SsStopPaymentRecJob", "SsBottomLineOutRecJob","NCOAOutboundRecJob", "OutboundDomesticTaxRecJob", "CashedCheckRecJob", "StopAcknowledgementRecJob", "StopConfirmationRecJob",
                "SsCashedCheckRecJob","SsBottomLineInRecJob", "CorporateAddressResearchJob", "IndividualAddressResearchJob", "NCOALinkRecJob", "DamascoInRecJob");
