...
public class EnvironmentPropertiesValidator implements Validator {
    ...
    public static final String SAEC_ENVIRONMENT_PROPERTIES = "META-INF/spring/saec-batch-files-environment.properties";
    ...
    private void validateSaecProperties(Properties saecProperties, ValidationMessageContext messageContext) {
        ...
        verifyCanWrite("batchFilesArchiveRootFolder", saecProperties, messageContext);

        verifyCanWrite("tempFolder", saecProperties, messageContext);
