...
@Component("SsCashedCheckRecJobNotificationHandler")
public class SsCashedCheckRecJobNotificationHandler extends AbstractJobNotificationHandler {
    ...
    private String getQuery() {
        String jpaQl =
                ...
                "from com.bfds.saec.batch.file.domain.in.ss_cashed_check.SsCashedCheckRec c " +
