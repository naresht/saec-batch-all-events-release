...
@Component("DbIssueVoidRecJobNotificationHandler")
public class DbIssueVoidRecJobNotificationHandler extends AbstractJobNotificationHandler {
    ...
    protected Map<String, Object> getNotificationModel(JobExecution jobExecution) {
        ...
        ret.put(MAIL_SUBJECT, getDBIssueVoidMailSubject());
        return ret;
    }
    ...
    private String getQuery() {
        String jpaQl =
                ...
                "from com.bfds.saec.batch.file.domain.out.db_issue_void.DbIssueVoidRec c " +
                " where c.jobExecutionId = :jobExecutionId "+
                " group by c.dda";
        return jpaQl;
    }
	
    private String getDBIssueVoidMailSubject() {
		SimpleDateFormat formatter = new SimpleDateFormat("MMddyyyy");
		String currentMonthDateYear = formatter.format(new Date());
		String subject = "DB issue/void_" + currentMonthDateYear + "";
		return subject;
	}
}
