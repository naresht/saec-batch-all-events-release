...
@Component("IfdsIssueVoidRecJobNotificationHandler")
public class IfdsIssueVoidRecJobNotificationHandler extends AbstractJobNotificationHandler {
    ...
    private String getQuery() {
        String jpaQl =
                "select c.dda, count(c.id),  sum(c.amount)  " +
                "from com.bfds.saec.batch.file.domain.out.ifds_issue_void.IfdsIssueVoidRec c " +
